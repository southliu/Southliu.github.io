import{j as r}from"./react.981c89a4.js";import{u as W}from"./page_content_article.3e44a9cb.js";import{B as u}from"./antd.c52db168.js";function g(){return[t=>{const{content:o,height:l,width:s,rotate:p,color:h,fontSize:y,opacity:f}=t;if(document.getElementById("south_watermark")!==null)return;const k=Math.floor(document.body.clientWidth/s)*2;let m="";for(let n=0;n<k;n++){const v=`
