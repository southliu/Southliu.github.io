import{g as E,d as r,c as $,f as N,b as T}from"./@babel_runtime.494ad229.js";import{r as o,R}from"./react.fd625a73.js";import{C as rn,a as on,b as Q,E as an,I as ln,c as cn,D as sn,L as dn,S as B,d as un,e as fn,R as mn,f as Cn,P as W,g as On,h as gn,i as yn,Q as vn,j as pn,k as wn,U as Sn,l as En,m as Tn,n as Rn,F as $n,H as Nn,o as hn,p as Fn,M as bn,q as xn,r as kn,s as Dn,t as In,u as Pn,v as Ln,w as _n,x as An,y as Mn,z as Un,A as zn,B as qn,G as Vn,J as jn,K as Hn,N as Qn,O as Bn,T as Wn,V as Gn,W as Jn}from"./@ant-design_icons-svg.5cc54d29.js";import{c as G}from"./classnames.2e4736b8.js";import{g as Kn,a as Xn}from"./@ant-design_colors.d68ffaae.js";import{b as J,a as K}from"./rc-util.ed7bc3a7.js";var Yn=o.createContext({});const X=Yn;function Zn(t,e){J(t,"[@ant-design/icons] ".concat(e))}function q(t){return E(t)==="object"&&typeof t.name=="string"&&typeof t.theme=="string"&&(E(t.icon)==="object"||typeof t.icon=="function")}function V(){var t=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};return Object.keys(t).reduce(function(e,n){var l=t[n];switch(n){case"class":e.className=l,delete e.class;break;default:e[n]=l}return e},{})}function A(t,e,n){return n?R.createElement(t.tag,r(r({key:e},V(t.attrs)),n),(t.children||[]).map(function(l,i){return A(l,"".concat(e,"-").concat(t.tag,"-").concat(i))})):R.createElement(t.tag,r({key:e},V(t.attrs)),(t.children||[]).map(function(l,i){return A(l,"".concat(e,"-").concat(t.tag,"-").concat(i))}))}function Y(t){return Kn(t)[0]}function Z(t){return t?Array.isArray(t)?t:[t]:[]}var et=`
.anticon {
...
//# sourceMappingURL=@ant-design_icons.2c11db67.js.map
