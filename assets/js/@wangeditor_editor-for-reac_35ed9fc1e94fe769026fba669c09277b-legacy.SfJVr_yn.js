System.register(["./react@19.2.4-legacy.Bke7ZeOw.js","./@wangeditor_editor@5.1.23-legacy.-U5Y_gjP.js"],function(e,t){"use strict";var n,r,o,a;return{setters:[function(e){n=e.a,r=e.e},function(e){o=e.a,a=e.i}],execute:function(){e({c:function(e){var t=e.editor,a=e.defaultConfig,l=void 0===a?{}:a,u=e.mode,i=void 0===u?"default":u,c=e.style,f=void 0===c?{}:c,s=e.className,d=n.useRef(null);return n.useEffect(function(){null!=d.current&&null!=t&&o({editor:t,selector:d.current,config:l,mode:i})},[t]),r.createElement("div",{style:f,ref:d,className:s})},u:function(e){var o=e.defaultContent,u=void 0===o?[]:o,i=e.onCreated,c=e.defaultHtml,f=void 0===c?"":c,s=e.value,d=void 0===s?"":s,v=e.onChange,y=e.defaultConfig,m=void 0===y?{}:y,g=e.mode,h=void 0===g?"default":g,C=e.style,p=void 0===C?{}:C,b=e.className,E=n.useRef(null),S=l(n.useState(null),2),j=S[0],w=S[1],N=l(n.useState(""),2),x=N[0],H=N[1],O=function(e){i&&i(e);var t=m.onCreated;t&&t(e)},D=function(e){H(e.getHtml()),v&&v(e);var t=m.onChange;t&&t(e)},R=function(e){var t=m.onDestroyed;w(null),t&&t(e)};return n.useEffect(function(){if(null!=j&&d!==x)try{j.setHtml(d)}catch(r){}},[d]),n.useEffect(function(){var e;if(null!=E.current&&null==j&&!(null===(e=E.current)||void 0===e?void 0:e.getAttribute("data-w-e-textarea"))){var n=a({selector:E.current,config:t(t({},m),{onCreated:O,onChange:D,onDestroyed:R}),content:u,html:f||d,mode:h});w(n)}},[j]),r.createElement("div",{style:p,ref:E,className:b})}});
/*! *****************************************************************************
