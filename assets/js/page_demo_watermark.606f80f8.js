import{j as r}from"./react.e58b2294.js";import{u as W}from"./page_content_article.a52b7039.js";import{B as u}from"./antd.a9b3ffac.js";function g(){return[t=>{const{content:o,height:l,width:s,rotate:p,color:h,fontSize:y,opacity:f}=t;if(document.getElementById("south_watermark")!==null)return;const k=Math.floor(document.body.clientWidth/s)*2;let m="";for(let n=0;n<k;n++){const v=`
