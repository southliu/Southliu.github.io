import{j as a,r as i}from"./react.981c89a4.js";import{P as g}from"./components_Business.0c4299c0.js";import{u as c}from"./ahooks.ef7fba82.js";import{I as f}from"./antd.c52db168.js";const h=new Array(5).fill(0).map((n,t)=>t+1);function m(n){const{strength:t}=n;return a.jsx("div",{className:"flex items-center",children:h.map(s=>a.jsx("div",{className:`
              w-19%
              h-5px
              mt-5px
              mr-1%
