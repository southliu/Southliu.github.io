import{j as a,r as i}from"./react.e58b2294.js";import{P as g}from"./components_Business.db97bd84.js";import{u as c}from"./ahooks.251fad70.js";import{I as f}from"./antd.2930504f.js";const h=new Array(5).fill(0).map((n,t)=>t+1);function m(n){const{strength:t}=n;return a.jsx("div",{className:"flex items-center",children:h.map(s=>a.jsx("div",{className:`
              w-19%
              h-5px
              mt-5px
              mr-1%
