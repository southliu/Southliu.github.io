import{a as C,F as A,j as e}from"./components_Bottom.f4335771.js";import{r as U,P as me,u as Y}from"./components_Business.9c5a5492.js";import{r as p}from"./react.c6268275.js";import{u as O,a as m}from"./react-redux.448135fc.js";import{c as de}from"./@reduxjs_toolkit.effa545d.js";import{g as fe,s as V,a as he,f as pe,d as K,b as H,c as ge,t as q,e as L,h as I,i as E,j as Z,G as ye,k as be,l as xe,m as ve,n as ke,o as ee,p as Ce,q as _e,r as we}from"./components_GlobalSearch.7fbb1e08.js";import{u as Ne}from"./ahooks.7831a49e.js";import{I as S}from"./@iconify_react.8d8aee98.js";import{u as z,a as B,b as Me}from"./react-router.c3a7686c.js";import{j as Pe,F as R,I as Te,m as F,k as se,l as G,M as je,T as ne,n as Oe,h as Re}from"./antd.b3c178e3.js";import{r as te,K as ze}from"./react-activation.46044aa5.js";import{F as $e,a as J}from"./components_Fullscreen.7b4a6410.js";import{D as Ke}from"./components_DataScreen.25f9da6c.js";import{T as Le}from"./components_Theme.c05e0bfa.js";import{B as Ie}from"./components_Modal.bf96e6b1.js";import{P as W}from"./components_PasswordStrength.b1647611.js";import{G as Ee,J as Se,K as Be,N as De,B as Fe,O as Ae,c as Ue,V as qe,T as Q}from"./@ant-design_icons.8a8d7944.js";import{F as Ge}from"./page_403.tsx_index.c60aec7c.js";function Ds(s){return U.post("/login",s)}function Ve(s){return U.post("/update-password",s)}const oe=de({name:"user",initialState:{permissions:[],userInfo:{id:0,username:"",email:"",phone:""}},reducers:{setUserInfo:(s,n)=>{s.userInfo=n.payload},setPermissions:(s,n)=>{s.permissions=n.payload},clearInfo:s=>{s.userInfo={id:0,username:"",email:"",phone:""}}}}),{setUserInfo:He,setPermissions:X,clearInfo:Je}=oe.actions,Fs=oe.reducer,We=s=>{const n=[];for(let o=0;o<s.length;o++){const{id:u,operation:a}=s[o];n.push(`/${u}`);for(let g=0;g<a.length;g++)n.push(`/${u}/${a[g]}`)}return n},As=(s,n)=>!n||n.length===0?!1:n.includes(s),Qe="/assets/svg/logo.17e50649.svg";function Xe(s){return U.get("/authority/user/refresh-permissions",{params:s})}const Ye="_header_11yja_1",Ze="_headerCloseMenu_11yja_12",es="_headerDriver_11yja_15",ss="_menu_11yja_18",ns="_menuClose_11yja_26",ts="_con_11yja_29",os="_conCloseMenu_11yja_36",as="_conMaximize_11yja_39",rs="_headerNone_11yja_43",is="_none_11yja_47",cs="_menuNone_11yja_50",ls="_conPhone_11yja_54",us="_headerPhone_11yja_57",ms="_leftDivide_11yja_60",k={header:Ye,headerCloseMenu:Ze,headerDriver:es,menu:ss,menuClose:ns,con:ts,conCloseMenu:os,conMaximize:as,headerNone:rs,none:is,menuNone:cs,conPhone:ls,headerPhone:us,leftDivide:ms};function ds(){const s=z(),{pathname:n}=B(),o=O(),[u,a]=p.useState([]),g=m(t=>t.menu.selectedKeys),d=m(t=>t.menu.openKeys),v=m(t=>t.tabs.isMaximize),f=m(t=>t.menu.isCollapsed),h=m(t=>t.menu.isPhone),x=m(t=>t.user.permissions);p.useEffect(()=>{const t=fe(n);!h&&!f&&(o(V(t)),o(he(n)))},[n]),p.useEffect(()=>{if(x.length>0){const t=pe(K,x);a(t||[])}},[x]);const y=t=>{s(t);const b=L({menus:u,permissions:x,key:t});b&&(o(I(b.key)),o(E(b.nav)),o(Z(b)))},r=t=>{y(t.key),h&&P()},_=(t,l)=>{let b=!0;for(let M=0;M<t.length;M++)if(t[M]!==l[M]){b=!1;break}return b},c=t=>{const l=[];let b="";if(t.length>0){b=t[t.length-1];const M=H(b);l.push(b);for(let T=t.length-2;T>=0;T--){const D=H(t[T]);_(D,M)&&l.unshift(t[T])}}o(V(l))},w=()=>{const t=ge(u,x);y(t),h&&P()},P=()=>{o(q(!0))};return C(A,{children:[C("div",{className:`
          transition-all
          overflow-auto
          z-2
          ${k.menu}
