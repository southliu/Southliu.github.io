import{j as s,F as S,a as i}from"./components_Bottom.f649ec7b.js";import{s as T}from"./components_Fullscreen.839103dc.js";import{r as l}from"./react.017637b6.js";import{r as g,T as u,f as v,u as L}from"./components_Business.4504c7d5.js";import{u as E,p as P}from"./page_content_article.6a3255e3.js";import{u as j,a as M}from"./react-redux.dedf6ab1.js";import{c as O}from"./@reduxjs_toolkit.d0210b58.js";import{g as p,d as h}from"./components_GlobalSearch.0f782fbe.js";import{u as B}from"./react-router.fee81168.js";import{F as n,I as f,B as C,m as U}from"./antd.b8eb8a06.js";import{G as q,J as R}from"./@ant-design_icons.c4447d7c.js";function _(e){return g.post("/login",e)}function ae(e){return g.post("/update-password",e)}const x=O({name:"user",initialState:{permissions:[],userInfo:{id:0,username:"",email:"",phone:""}},reducers:{setUserInfo:(e,a)=>{e.userInfo=a.payload},setPermissions:(e,a)=>{e.permissions=a.payload},clearInfo:e=>{e.userInfo={id:0,username:"",email:"",phone:""}}}}),{setUserInfo:A,setPermissions:D,clearInfo:te}=x.actions,re=x.reducer,G="/assets/svg/logo.63a26457.svg";function oe(){E("登录");const e=B(),a=j(),[k,b]=L(),[w,c]=l.exports.useState(!1),F=M(t=>t.user.permissions),r=localStorage.getItem(u)||"light";return l.exports.useEffect(()=>{r||localStorage.setItem(u,"light"),r==="dark"&&(document.body.className="theme-dark"),a(T(r==="dark"?"dark":"light"))},[r]),l.exports.useEffect(()=>{if(k()){const t=p(h,F);e(t)}},[]),s(S,{children:s("div",{className:`
