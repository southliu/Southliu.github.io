import{a as C,F as H,j as e}from"./components_Bottom.700b5d0d.js";import{r as V,P as me,u as _}from"./components_Business.8bf97dd0.js";import{r as p}from"./react.fd625a73.js";import{u as X,a as m}from"./react-redux.b3b030f1.js";import{c as de}from"./@reduxjs_toolkit.ce174c75.js";import{g as fe,s as q,a as he,f as pe,d as j,b as J,c as ve,t as U,e as R,h as K,i as z,j as $,G as ge,k as ye,l as be,m as xe,n as Ne,o as ee,p as Ce,q as Ae,r as Me}from"./components_GlobalSearch.710a92f6.js";import{u as ke}from"./ahooks.5aecf1e0.js";import{I as S}from"./@iconify_react.b3e9d196.js";import{u as E,a as W,b as Oe}from"./react-router.7e891526.js";import{j as we,F as B,I as Pe,m as L,k as se,l as F,M as Te,T as ne,n as Xe,h as Be}from"./antd.ac81835c.js";import{r as te,K as Ee}from"./react-activation.f36feb82.js";import{F as Ie,a as Q}from"./components_Fullscreen.a51d8927.js";import{D as je}from"./components_DataScreen.90c2d822.js";import{T as Re}from"./components_Theme.4fcb14c1.js";import{B as Ke}from"./components_Modal.286f4c6a.js";import{P as G}from"./components_PasswordStrength.ff6623fe.js";import{K as ze,N as Se,O as We,T as De,B as Le,V as He,W as Ve,X as Ue,Y}from"./@ant-design_icons.2c11db67.js";import{F as Fe}from"./page_403.tsx_index.67d14fe2.js";function Ds(s){return V.post("/login",s)}function qe(s){return V.post("/update-password",s)}const oe=de({name:"user",initialState:{permissions:[],userInfo:{id:0,username:"",email:"",phone:""}},reducers:{setUserInfo:(s,n)=>{s.userInfo=n.payload},setPermissions:(s,n)=>{s.permissions=n.payload},clearInfo:s=>{s.userInfo={id:0,username:"",email:"",phone:""}}}}),{setUserInfo:Je,setPermissions:Z,clearInfo:Qe}=oe.actions,Ls=oe.reducer,Ge=s=>{const n=[];for(let o=0;o<s.length;o++){const{id:u,operation:a}=s[o];n.push(`/${u}`);for(let v=0;v<a.length;v++)n.push(`/${u}/${a[v]}`)}return n},Hs=(s,n)=>!n||n.length===0?!1:n.includes(s),Ye="/assets/svg/logo.17e50649.svg";function Ze(s){return V.get("/authority/user/refresh-permissions",{params:s})}const _e="_header_11yja_1",$e="_headerCloseMenu_11yja_12",es="_headerDriver_11yja_15",ss="_menu_11yja_18",ns="_menuClose_11yja_26",ts="_con_11yja_29",os="_conCloseMenu_11yja_36",as="_conMaximize_11yja_39",rs="_headerNone_11yja_43",is="_none_11yja_47",cs="_menuNone_11yja_50",ls="_conPhone_11yja_54",us="_headerPhone_11yja_57",ms="_leftDivide_11yja_60",N={header:_e,headerCloseMenu:$e,headerDriver:es,menu:ss,menuClose:ns,con:ts,conCloseMenu:os,conMaximize:as,headerNone:rs,none:is,menuNone:cs,conPhone:ls,headerPhone:us,leftDivide:ms};function ds(){const s=E(),{pathname:n}=W(),o=X(),[u,a]=p.useState([]),v=m(t=>t.menu.selectedKeys),d=m(t=>t.menu.openKeys),x=m(t=>t.tabs.isMaximize),f=m(t=>t.menu.isCollapsed),h=m(t=>t.menu.isPhone),b=m(t=>t.user.permissions);p.useEffect(()=>{const t=fe(n);!h&&!f&&(o(q(t)),o(he(n)))},[n]),p.useEffect(()=>{if(b.length>0){const t=pe(j,b);a(t||[])}},[b]);const g=t=>{s(t);const y=R({menus:u,permissions:b,key:t});y&&(o(K(y.key)),o(z(y.nav)),o($(y)))},r=t=>{g(t.key),h&&w()},A=(t,l)=>{let y=!0;for(let O=0;O<t.length;O++)if(t[O]!==l[O]){y=!1;break}return y},c=t=>{const l=[];let y="";if(t.length>0){y=t[t.length-1];const O=J(y);l.push(y);for(let P=t.length-2;P>=0;P--){const D=J(t[P]);A(D,O)&&l.unshift(t[P])}}o(q(l))},M=()=>{const t=ve(u,b);g(t),h&&w()},w=()=>{o(U(!0))};return C(H,{children:[C("div",{className:`
          transition-all
          overflow-auto
          z-2
          ${N.menu}
...
//# sourceMappingURL=layouts.d8b75de3.js.map
